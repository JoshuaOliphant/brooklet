...
def session_dir(tmp_path):
    ...
    write_session_file(
        ...
        [
            make_session_event(
                "user", "aaaa1111-0000-0000-0000-000000000001", "2026-03-15T02:00:00Z"
            ),
            make_session_event(
                "assistant",
                "aaaa1111-0000-0000-0000-000000000001",
            ...
            make_session_event(
                "user", "aaaa1111-0000-0000-0000-000000000001", "2026-03-15T02:03:00Z"
            ),
        ],
    )
    ...
    write_session_file(
        ...
        [
            make_session_event(
                "user", "bbbb2222-0000-0000-0000-000000000002", "2026-03-15T03:00:00Z"
            ),
            make_session_event(
                "assistant",
                "bbbb2222-0000-0000-0000-000000000002",
            ...
            make_session_event(
                "user", "bbbb2222-0000-0000-0000-000000000002", "2026-03-15T03:10:00Z"
            ),
        ],
    )
    ...
    write_session_file(
        ...
        [
            make_session_event(
                "user", "cccc3333-0000-0000-0000-000000000003", "2026-03-15T04:00:00Z"
            ),
            make_session_event(
                "assistant", "cccc3333-0000-0000-0000-000000000003", "2026-03-15T04:30:00Z"
            ),
        ],
    )
    ...
    write_session_file(
        ...
        [
            make_session_event(
                "user", "dddd4444-0000-0000-0000-000000000004", "2026-03-15T05:00:00Z"
            ),
            make_session_event(
                "progress", "dddd4444-0000-0000-0000-000000000004", "2026-03-15T05:01:00Z"
            ),
            make_session_event(
                "assistant",
                "dddd4444-0000-0000-0000-000000000004",
    ...
    write_session_file(
        ...
        [
            make_session_event(
                "user", "eeee5555-0000-0000-0000-000000000005", "2026-03-15T06:00:00Z"
            ),
            make_session_event(
                "assistant",
                "eeee5555-0000-0000-0000-000000000005",
